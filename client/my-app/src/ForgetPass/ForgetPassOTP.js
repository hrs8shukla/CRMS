...
export default function ForgetPassOTP(){
  ...
  return (
    <>
      <div className="log-super-container">
          ...
          <form id="form" className="log-form">
            <div className="log-form-control form-control">
              ...
              <input
                ...
                type="text"
                id="userid"
                placeholder="Enter email id to get otp"
              />
              <small>Error message</small>
            </div>
            {/* <button type="submit" onClick = {AdminLogin}>LOGIN</button> */}
            <div className="butotp" onClick="">
              SEND
            </div>
            <div className="backTolog" onClick="">
              <a href="/AdminLogin" className="back-sign" id="sign-id">
                BACK TO LOGIN
              </a>
            </div>
          </form>
