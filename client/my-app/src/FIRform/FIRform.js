...
export default function FIRForm() {
 ...
 const navigate = useNavigate();
  ...
  return (
    <>
      <div className="fir-super-container">
        <Navbar />
        ...
        <div className="FIR-container ">
          <form id="form" className="FIR-form">
            <div className="FIR-head-sign">
              ...
              <p className="FIR-head-p">(Under Section 154 Cr. P.C)</p>
            </div>
            ...
            <div>
              ...
              <div className="FIR-form-control FIR-add-pre-sub">
                ...
                <select
                  id="inputState"
                  className="FIR-form-select FIR-form-control1 FIR-state-input"
                  name="state"
                  value={user.state}
        ...
        <div className="FIR-form-control  FIR-add-pre-sub2"><span className="FIR-simp-text">(iii)</span>
          ...
          <div className="FIR-form-control FIR-add-pre-sub4">
            ...
            <div className="FIR-">
              ...
              <div className="FIR-form-control FIR-add-pre-sub5">
                <label
                  ...
                  className="FIR-form-label FIR-small-label"
                >
                  Direction and Distnce from P.S
                </label>
                <input
                  id="inputZip"
                  className="FIR-form-control1 FIR-zip-input"
                  name="directionAndDistncefromPS"
                  value={user.directionAndDistncefromPS}
                  onChange={handleChange}
                  type="text"
                />
              </div>
            ...
            <div className="FIR-addr-text-main">
              <div className="FIR-form-control ">
                <label
                  ...
                  className="FIR-form-label FIR-small-label"
                >
                  <span className="FIR-simp-text7">(b)</span>Address
                </label>
                <textarea
                  className="FIR-addr-text"
                  rows="8"
                  cols="80"
                  id="inputAddress"
                  name="address"
                  value={user.address}
                  onChange={handleChange}
                  placeholder="Enter detailed location of place of occurence  "
                ></textarea>
              </div>
            </div>
            ...
            <div className="FIR-addr-text-dist">
              <div className="FIR-form-control FIR-add-pre-sub6">
                <label
                  ...
                  className="FIR-form-label FIR-small-label"
                >
                  <span className="FIR-simp-text7">(c)</span>In case outside
                  limit of this Police Station, then enter the name of P.S and
                  District
                </label>
                <input
                  id="inputZip"
                  className="FIR-form-control1 FIR-zip-input"
                  name="outsideNameofPSAndDistrict"
                  value={user.outsideNameofPSAndDistrict}
                  onChange={handleChange}
                  type="textarea"
                />
              </div>
            ...
            <div className="FIR-form-control FIR-form-control6">
              ...
              <input
                className="FIR-name-input"
                type="text"
                id="name"
                placeholder="Enter your name"
                name="complainantName"
                value={user.complainantName}
                onChange={handleChange}
              />
            ...
            <div className="FIR-form-control FIR-form-control6">
              ...
              <input
                ...
                name="complainantFatherorHusbandName"
                value={user.complainantFatherorHusbandName}
                onChange={handleChange}
              />
              <small>Error message</small>
            </div>
            <div className="FIR-">
              <div className="FIR-form-control FIR-add-pre-sub">
                ...
                <input
                  id="inputZip"
                  className="FIR-form-control1 FIR-zip-input"
                  name="complainantDateOfBirth"
                  value={user.complainantDateOfBirth}
                  onChange={handleChange}
                  type="date"
                />
              </div>
              ...
              <div className="FIR-form-control FIR-add-pre-sub3">
                ...
                <input
                  ...
                  value={user.complainantNationality}
                  onChange={handleChange}
                  type="text"
                />
              </div>
              ...
              <div className="FIR-form-control FIR-add-pre-sub3">
                ...
                <input
                  ...
                  value={user.complainantOccupation}
                  onChange={handleChange}
                  type="text"
                />
              </div>
              ...
              <div className="FIR-">
                <div className="FIR-form-control FIR-add-pre-sub">
                  ...
                  <input
                    ...
                    value={user.complainantPassportNo}
                    onChange={handleChange}
                    type="text"
                  />
                </div>
                <div className="FIR-form-control FIR-add-pre-sub3">
                  ...
                  <input
                    id="inputZip"
                    className="FIR-form-control1 FIR-zip-input"
                    name="complainantDateofIssue"
                    value={user.complainantDateofIssue}
                    onChange={handleChange}
                    type="date"
                  />
                </div>
                <div className="FIR-form-control FIR-add-pre-sub3">
                  ...
                  <input
                    id="inputZip"
                    className="FIR-form-control1 FIR-zip-input"
                    name="complainantPlaceOfIssue"
                    value={user.complainantPlaceOfIssue}
                    onChange={handleChange}
                    type="text"
                  />
                </div>{" "}
              ...
              <div className="FIR-">
                <div className="FIR-form-control">
                  <label
                    ...
                    className="FIR-form-label FIR-small-label"
                  >
                    <span className="FIR-simp-text8">(g)</span>Address
                  </label>
                  <textarea
                    className="FIR-addr-info"
                    rows="8"
                    cols="80"
                    id="inputAddress"
                    placeholder="Enter your address"
                    name="complainantAddress"
                    value={user.complainantAddress}
                    onChange={handleChange}
                  ></textarea>
                </div>
              </div>
            ...
            <div className="FIR-">
              ...
              <div className="FIR-form-control ">
                <textarea
                  ...
                  cols="80"
                  id="inputAddress"
                  name="detailsOfSuspected"
                  value={user.detailsOfSuspected}
                  onChange={handleChange}
                  placeholder="Enter a brief details here..."
                ></textarea>
              </div>
            </div>
            ...
            <div className="FIR-">
              ...
              <div className="FIR-form-controls">
                <textarea
                  ...
                  cols="80"
                  id="inputAddress"
                  name="particularsOfPropertiesStolenInvolved"
                  value={user.particularsOfPropertiesStolenInvolved}
                  onChange={handleChange}
                  placeholder="Enter brief detail here..."
                ></textarea>
              </div>
           ...
           <button className="FIR-print-button button" onClick={window.print}> Print complaint </button>*/}
            <div className="FIR-print-button button" onClick={window.print}>
              {" "}
              Print complaint
            </div>
            {/* <button type="submit">SUBMIT</button> */}
            <div className="button" onClick={FIRform}>
              SUBMIT
            </div>
          </form>
        </div>
